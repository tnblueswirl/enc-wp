<div id="pb-builder" class="grey" data-id="<?php echo isset($_GET['id']) ? $_GET['id'] : "" ?>">
	<div id="pb-app-admin-header">
		<div id="pb-logo"></div>
		<div class="text-spot" id="pb-version"><p>PhotoBlocks <?php echo PHOTOBLOCKS_V . " " . PHOTOBLOCKS_PLAN ?></p></div>
		<?php if(photob_fs()->is_free_plan()) : ?>
		<div class="text-spot" id="premium-facts" data-link="<?php echo photob_fs()->get_trial_url() ?>">
    ...
    <div id="pb-header">
    	<div id="pb-app-header">
			<ul class="pb-app-menu">
				<?php if(photob_fs()->is_free_plan()) : ?>
				<li>
					<a class="pb-button pb-menu-upgrade warn" href="<?php echo photob_fs()->get_trial_url() ?>">UPGRADE!</a>
				</li>
				<?php endif ?>
				<li>
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide pb-form-slide" id="pb-panel-board"> 
                        <div class="artboard-menu">  
							...
							<a href="#" class="open-drawer" data-drawer="pb-grid-settings"><i class="pb-th"></i> <?php _e('Grid', 'photoblocks') ?></a>
							<?php if ( photob_fs()->is__premium_only() ) : ?>
							<a href="#" class="open-drawer" data-drawer="pb-source-settings"><i class="pb-th"></i> <?php _e('Posts', 'photoblocks') ?></a>
							<?php endif ?>
                        </div>
                    ...
                    <div class="swiper-slide pb-form-slide" id="pb-panel-gallery">
	                    <div class="pb-inner">
							...
							<div class="pb-section-group">
								<h3><?php _e('Debug info', 'photoblocks') ?></h3>
								<ul class="photoblocks-expandable js-group-debug settings-panel">
									<li class="field field-code-debug" data-code="debug-settings">
										<label class="pb-settings-label">
											<span class="control"><?php _e('Gallery settings', 'photoblocks') ?></span>
											<textarea readonly class="js-gallery-settings"></textarea>
										</label>
									</li>
									<li class="field field-code-debug" data-code="debug-blocks">
										<label class="pb-settings-label">
											<span class="control"><?php _e('Blocks settings', 'photoblocks') ?></span>
...
<div class="pb-modal" style="display:none" id="modal-add-blocks">
	<div class="pb-popup">
		...
		<div class="pb-toggle">
			<label><input type="checkbox" class="js-copy-captions"> <?php _e('Copy captions and alt when adding images', 'photoblocks') ?></label>
		</div>
		<div class="action-buttons">
			...
			<a class="button-add-images" href="#" onclick="PBAdmin.addBlocks('post')"><i class="pb-align-left"></i> <?php _e('Post', 'photoblocks') ?></a>
			<a class="button-add-images" href="#" onclick="PBAdmin.addBlocks('text')"><i class="pb-font"></i> <?php _e('Text', 'photoblocks') ?></a>
			<?php else : ?>
			<a class="button-add-images" href="#" onclick="PBAdmin.showPremium()"><i class="pb-align-left"></i> <?php _e('Post', 'photoblocks') ?></a>
...
<div class="pb-modal" style="display:none" id="modal-premium">
	<div class="pb-popup">
		...
		<p><?php _e('The requested feature is part of the Ultimate plan. You can purchase a license or activate a free 14-days trial.', 'photoblocks') ?></p>
		<div class="pb-popup-footer">
			<a href="?billing_cycle=annual&trial=true&page=photoblocks-pricing" class="pb-button pb-button-green"><?php _e('Trial', 'photoblocks') ?></a>	
			<!--<a href="?page=photoblocks-pricing" class="pb-button pb-button-green"><?php _e('Purchase', 'photoblocks') ?></a>-->
		</div>
	</div>
</div>
<script>
	var pb_trial_url = "<?php echo photob_fs()->get_trial_url() ?>";
</script>