...
class Photoblocks_Admin {
	...
	public function menu() {
		$this->dashboard_page 		= add_menu_page('Dashboard - PhotoBlocks', 'PhotoBlocks', 'edit_posts', $this->plugin_name, array($this, 'dashboard'), plugin_dir_url( __FILE__ ) . '/icon.png');
		$this->add_page 			= add_submenu_page($this->plugin_name, 	   __('Add new') . " - PhotoBlocks",         __('Add new'),         'edit_posts', $this->plugin_name . '-edit', array($this, 'edit'));
		$this->troubleshooting_page = add_submenu_page($this->plugin_name, __('Troubleshooting') . " - PhotoBlocks", __('Troubleshooting'), 'edit_posts', $this->plugin_name . '-troubleshooting', array($this, 'troubleshooting'));
	}
	...
	public function enqueue_styles() {
		...
		{
			wp_enqueue_style( 'chosen', plugin_dir_url( __FILE__ ) . 'css/chosen.css', array(), $this->version, 'all' );
		}
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( 'packery', plugin_dir_url( __FILE__ ) . '../public/js/packery.pkgd.js', array( 'jquery' ), $this->version, false );
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/photoblocks.admin.js', array( 'jquery', 'minicolors', 'packery', $this->plugin_name . '-grid' ), $this->version, false );
