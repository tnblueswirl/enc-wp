 ...
 *
 * @wordpress-plugin
 * Plugin Name: PhotoBlocks Grid Gallery (Premium)
...
if ( !function_exists( "photoblocks_starter" ) ) {
    function photoblocks_starter()
    {
        ...
        if ( photob_fs()->is__premium_only() ) {
            $photoblocks_plan = "premium";
            if ( photob_fs()->is_trial() ) {
                $photoblocks_plan .= " (trial)";
            }
            define( "PHOTOBLOCKS_PLAN", $photoblocks_plan );
