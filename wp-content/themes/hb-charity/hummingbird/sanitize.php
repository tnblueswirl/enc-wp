 ...
 */
function hb_charity_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function hb_charity_sanitize_css( $css ) {
 ...
 */
function hb_charity_sanitize_dropdown_pages( $page_id, $setting ) {
 ...
 */
function hb_charity_sanitize_email( $email, $setting ) {
 ...
 */
function hb_charity_sanitize_hex_color( $hex_color, $setting ) {
	// Sanitize $input as a hex value without the hash prefix.
 ...
 */
function hb_charity_sanitize_html( $html ) {
 ...
 */
function hb_charity_sanitize_image( $image, $setting ) {
	/*
 ...
 */
function hb_charity_sanitize_nohtml( $nohtml ) {
 ...
 */
function hb_charity_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function hb_charity_sanitize_number_range( $number, $setting ) {
 ...
 */
function hb_charity_sanitize_select( $input, $setting ) {
 ...
 */
function hb_charity_sanitize_url( $url ) {
 ...
 * @return int
 */
function hb_charity_sanitize_category($input){
	$output=intval($input);
	return $output;
}
 ...
 * @return string
 */
function hb_charity_sanitize_sidebar( $input ) {
	$valid = array(
		'left'   => 'Left',
		'right'  => 'Right',
		'none'	 => 'None',
