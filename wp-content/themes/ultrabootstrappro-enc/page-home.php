...
<!-- theme-slider -->
<?php if(get_theme_mod('slider_disable') != 0): ?>
      ...
      <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          <?php
            ...
            $ord =get_theme_mod('slider_post_order');
          ...
          <div class="item <?php echo $cn == 1 ? 'active' : ''; ?>">
            ...
            <div class="slide-caption">
              <div class="container">
                ...
                <a href="<?php the_permalink();?>" title="" class="btn btn-danger"><?php _e('View','ultrabootstrap'); ?></a>
                </div>
              </div>
            </div>
          </div> <!-- /.end of item -->
...
<section class="welcome">
	<div class="container">
    <div class="row">
      <div class="col-sm-7 col-sm-offset-5 spacer">
...
<?php if(get_theme_mod('featured_disable') != 0): ?>
<!-- post list  -->
<section class="post-list spacer">
  	<div class="container">
          <?php
            $fcid = get_theme_mod('features_display');
            $fcn  =  get_theme_mod('featured_no_of_posts');
            $ford =  get_theme_mod('featured_post_order');
            $category_link = get_category_link($fcid);
            $ultrabootstrap_cat = get_category($fcid);
            if ($ultrabootstrap_cat) {
          ?>
