...
<head>
	...
	<?php  if(get_theme_mod('ultrabootstrap_google_fontfamily_setting')){ ?>
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=<?php echo get_theme_mod('ultrabootstrap_google_fontfamily_setting'); ?>" type="text/css" media="screen">
    <?php }?>
	<?php wp_head(); ?>
</head>
